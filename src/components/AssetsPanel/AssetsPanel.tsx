...
const DETAIL_FIELDS: {
	...
	{
		textKey: "vehicles",
		valueKey: "vehiclesValue",
		label: "交通工具",
		placeholder: "汽车、摩托、船只",
	},
	{
		textKey: "residences",
		valueKey: "residencesValue",
		label: "住所",
		placeholder: "公寓、别墅、乡间宅邸",
	},
	{
		textKey: "luxuries",
		valueKey: "luxuriesValue",
		label: "奢侈品",
		placeholder: "珠宝、收藏品、名贵器材",
	},
	{
		textKey: "securities",
		valueKey: "securitiesValue",
		label: "股票 / 证券",
		placeholder: "债券、股票、基金份额",
	},
	...
	return isReadOnly ? (
		...
		<Box sx={{ display: "grid", gap: 2.5 }}>
			<Box
				...
				<MetricCard
					label="当前现金"
					value={`${assets.currentCash || 0} ${assets.currency || ""}`.trim()}
				/>
